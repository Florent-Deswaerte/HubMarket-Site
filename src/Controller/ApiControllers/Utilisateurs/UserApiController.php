...
{
    public function __construct(private UtilisateursRepository $userRepository, private APIUtilities $apiUtilities)
    {}
    ...
    #[Route("/api/users", name: 'apiCreateUser')]
    public function apiCreateUser(Request $request): Response|Utilisateurs
    {
    ...
    #[Route("/api/users/id/{id}", name: 'apiDeleteUser')]
